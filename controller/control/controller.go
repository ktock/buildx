...
type BuildxController interface {
	Build(ctx context.Context, options controllerapi.BuildOptions, in io.ReadCloser, statusChan chan *client.SolveStatus) (ref string, resp *client.SolveResponse, err error)
